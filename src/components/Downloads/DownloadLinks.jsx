...
function DownloadLinks() {
  ...
  return (
    <div
      className="min-h-screen bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center px-4 sm:px-6 md:px-12 lg:px-20 py-10 sm:py-16 lg:py-20 space-y-6"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-800 text-center mb-2 tracking-tight mt-10">
  Download Links
</h1>
      ...
      <div className="mt-6 p-4 sm:p-6 bg-yellow-50 border border-yellow-200 rounded-xl text-sm sm:text-base text-yellow-800 max-w-5xl w-full">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-800">
          ...
          <li>Open the Launcher, wait for the patch to complete, and click Start.</li>
        </ol>
